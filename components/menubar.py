...
class ContourMenuBar(tk.Menu):
    def __init__(self, parent):
        ...
        self.add_command(
            label="Video Tracking w/ HSV",
            command=parent.gui.video_tracking_hsv)
        self.add_command(
            label="Video Tracking w/ Occlusion",
            command=parent.gui.video_tracking_occlusion)
        self.add_command(
            label="Video Tracking w/ HSV & Occlusion",
            command=parent.gui.video_tracking_hsv_occlusion)
        self.add_command(
